...
function setupScreens(){
    var WelcomeScreen = new ScreenUIElements(
        ...
        new UIElementHTML(undefined, "Hallo Testperson. Danke, dass Sie freiwillig an diesem Test teilnehmen!"),
    ...
    var Tutorial = new ScreenUIElements(
        ...
        new UIElementHTML("questionnaireItem", "<h2>Gesamtqualität</h2> Wie würden Sie die allgemeine Qualität dieser Audio bewerten? Eher gut oder schlecht?"),
        ...
        new UIElementHTML("questionnaireItem", "<h2>Lautstärke</h2> Finden Sie die Audio zu laut oder leise oder ist es genau optimal?"),
        new UIElementHTML("questionnaireItem", "<h2>Rauschen</h2> Hören Sie ein Rauschen oder andere Störgeräusche in dieser Audiodatei und wie stark?"),
    ...
    for(let i = 0; i < pB[0].length; i++){
        ...
        var AudioSampleScreen = new ScreenUIElements(
            ...
            new QuestionnaireItemSVGNASATLX("questionnaireItem", "<h2>Lautstärke</h2> Bitte bewerten Sie die Lautstärke (Empfinden Sie die Audio als zu laut oder leise oder ist es genau optimal?)", false, "nicht optimal", "optimal"),
            new QuestionnaireItemSVGNASATLX("questionnaireItem", "<h2>Rauschen</h2> Bitte bewerten Sie das Rauschen (Sind Störgeräusche in dieser Audiodatei erkennbar und wie stark?)", false, "rauschhaftig", "unrauschhaftig"),  
        );
    ...
    var BreakScreen1 = new ScreenUIElements(
        ...
        new UIElementHTML(undefined, "Sie können kurz 10 Minuten Pause machen und dann weiter machen."),
    );
